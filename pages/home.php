...
<section id="differentials"><img src="assets/img/leaf.png" class="logo"/>
  ...
  <div class="icons">
    <div class="wrap">
      <figure><img src="assets/img/1.png" alt=""/>
        <figcaption>PISCINA ADULTO E INFANTIL</figcaption>
      </figure>
      <figure><img src="assets/img/2.png" alt=""/>
        <figcaption>BICICLETÁRIO</figcaption>
      </figure>
      <figure><img src="assets/img/3.png" alt=""/>
        <figcaption>PLAYGROUND E BRINQUEDOTECA</figcaption>
      </figure>
      <figure><img src="assets/img/4.png" alt=""/>
        <figcaption>NATUREZA PRÓXIMA PRESERVADA</figcaption>
      </figure>
    </div>
  </div>
</section>
<section id="greenpark">
  <div class="wrap"><img src="assets/img/leaf.png" class="logo"/>
    ...
    <figure><img src="assets/img/illustrative-01.png" alt=""/><img src="assets/img/illustrative-02.png" alt=""/>
      <figcaption>Imagens ilustrativas do Residencial GreenPark</figcaption>
    </figure>
    <div class="text">
      <p>GreenPark é um residencial vertical completo, cercado por muito verde, ar puro e tranquilidade. Está localizado perto do centro e ao mesmo tempo longe do barulho e da poluição da cidade. São 88 apartamentos de 65 a 74m2, com  garagem coberta e varanda gourmet. Um execelente lugar para morar ou para investir. </p>
...
<section id="blueprint">
  <div class="wrap">
    <div class="thumbs">
      <button data-number="1" class="left active">PLANTA APTO 65M²</button>
      <button data-number="2" class="right">PLANTA APTO 74M²</button>
    </div>
...
<section id="location">
  <div class="wrap">
    ...
    <p class="subtitle">OUTRAS DISTÂNCIAS - Clique aqui para visualizar a distância do GreenPark à outros pontos e cidades. </p>
    <div class="address"><img src="assets/img/location.png"/>
      <p>RUA REMIGIO DALLA VECCHIA, 765 JARDIM PLANALTO - SALTO</p>
    </div>
  </div>
  <div id="map"></div>
</section>
